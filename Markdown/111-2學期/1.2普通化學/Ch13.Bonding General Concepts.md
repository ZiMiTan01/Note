...
* **Ans**
  ...
  $$E=2.31\times10^{-19}(J \cdot nm)\times(\frac{Q_1Q_2}{r})=2.31\times 10ˆ{-19}\times \frac{+2\times -2}{0.205}=4.51\times 10ˆ{-21} kJ/\text{ion pair}$$

  $$\therefore \text{For 1 mole ion pair}\Rightarrow E=-4.51\times 10ˆ{-21}\times 6.02\times 10ˆ{23}=-2710 kJ/mol$$
